...
5. 将**散点图**视觉对象添加到报表页，然后调整其位置和大小，以使其填满整个页面。
...
7. 在 **“筛选器”** 窗格中，将 **“产品** | **“Category”** 字段添加到 **“此页上的筛选器”** 井中。

8. 在筛选器卡片中，按 **“自行车”** 筛选。

	![图片 40](Linked_image_Files/PowerBI_Lab11A_image8.png)

9. 要为图表制作动画，请单击左下角的 **“播放”**。

	![图片 41](Linked_image_Files/PowerBI_Lab11A_image9.png)

10. 观看从 **“2018 财年第一季度”** 到 **“2020 财年第四季度”** 的整个动画周期。

	*使用散点图，可以同时了解度量值：在此案例中，度量值为订单数量、销售收入和利润率*。

	*每个气泡代表一个经销商业务类型。气泡大小的变化反映了订单数量的增加或减少。水平运动代表销售收入的增加或减少，垂直运动代表收益率的增加或减少*。

11. 动画停止时，单击其中一个气泡即可显示它在一段时间内的跟踪信息。

12. 将光标悬停在任何气泡上方，可显示一个工具提示，描述此经销商类型在此时间点的度量值。

13. 在 **“筛选器”** 窗格中，仅按 **“服装”** 筛选，注意它会产生迥然不同的结果。
...
16. 在报表页面中添加一个 **“折线图”** 视觉对象，然后重新调整其位置和大小，以将其填满整个页面。
...
18. 在 **“筛选器”** 窗格中，添加 **“Date”** | **“Year”** 字段添加到 **“此页上的筛选器”** 井中。

19. 在筛选器卡片中，按两个年度筛选：**“FY2019”** 和 **“FY2020”**。

	![图片 47](Linked_image_Files/PowerBI_Lab11A_image14.png)

	*对一段时间进行预测时，至少需要两个周期（年度）的数据才能生成准确、稳定的预测*。

20. 然后将 **“Product”** | **“Category”** 字段添加到 **“此页上的筛选器”** 井中，然后按 **“Bikes”** 筛选。

	![图片 48](Linked_image_Files/PowerBI_Lab11A_image15.png)

21. 要添加预测，请在 **“可视化”** 窗格下，选择 **“分析”** 窗格。
...
26. 在线形视觉对象中，请注意，预测已超出历史记录数据一个月。

	*灰色区域表示置信度。置信度越大，预测可能会越不稳定（因此准确性就越差）*。

	*当你知道周期的长度（在这种情况下为年度）时，应输入季节性点。有时可能是每周 (7) 或每月 (30)*。

27. 在**筛选器**窗格，仅依据 **“Clothing”** 筛选，请注意，它会产生不同的结果。

28. 保存 Power BI Desktop 文件。
...
33. 在 **“筛选器”** 窗格中，添加 **“Date | Year”** 字段至 **“此页上的筛选器”** 井，然后将筛选器设置为 **“FY2020”**。

	![图片 59](Linked_image_Files/PowerBI_Lab11A_image24.png)

34. 在分解树视觉对象中，注意树的根：**利润率**为 -0.94％

	![图片 60](Linked_image_Files/PowerBI_Lab11A_image25.png)

35. 单击加号图标，然后在“上下文”菜单中选择 **“高值”**。

	![图片 61](Linked_image_Files/PowerBI_Lab11A_image26.png)

36. 注意，决策树显示了从最高到最低利润率排序的经销商。

37. 要删除级别，请在视觉对象顶部的 **“Reseller”** 标签旁边，单击 **“X”**。

	![图片 62](Linked_image_Files/PowerBI_Lab11A_image27.png)

38. 再次单击加号图标，然后展开到 **“Country-Region”** 级别。

39. 从 **“United States”** 扩展到 **“State-Province”** 级别。

40. 使用位于 **“State-Province”** 视觉对象底部的向下箭头，然后滚动到利润较低的州。

41. 注意 **“New York”** 州的盈利为负。

42. 从 **“New York”** 扩展到 **“Reseller”** 级别。
...
46. 在 **“插入”** 功能区，从 **“AI 视觉对象”** 组里面，单击 **“关键影响者”**。

	*提示： AI 视觉对象也在**可视化**窗格提供*。

	![图片 71](Linked_image_Files/PowerBI_Lab11A_image30.png)

47. 重新定位视觉对象并调整其大小，以使其占据整个页面。
...
49. 在视觉对象的左上方，请注意 **“关键影响者”** 已成为重点，并设置了特定影响以了解哪个地方的利润率会增加。

	![图片 76](Linked_image_Files/PowerBI_Lab11A_image33.png)

50. 查看结果，即 **“Bothel”** 城更有可能增加。

51. 修改目标以确定影响利润率下降的因素。

	![图片 77](Linked_image_Files/PowerBI_Lab11A_image34.png)

52. 查看结果。

53. 要检测细分，请选择左上角的 **“顶层细分”**。

	![图片 78](Linked_image_Files/PowerBI_Lab11A_image35.png)

54. 注意，现在的目标是确定利润率可能很高的细分。

55. 当视觉对象显示细分（如圆形）时，单击其中之一以显示有关细分的信息。
...
59. 将文件发布到你的 **“销售分析”** 工作区。

60. 关闭 Power BI Desktop。

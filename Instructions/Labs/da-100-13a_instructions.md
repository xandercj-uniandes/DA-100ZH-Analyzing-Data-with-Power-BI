...
12. 若要修改报表标题文本框文本，请单击文本框内部，然后输入：**销售订单报表**
...
19. 若要将图像添加到报表设计中，请单击报表标题文本框右侧的报表标题区域内部。
...
34. 在**连接属性**窗口中的 **“服务器名称”** 框，输入 **“localhost”**。
...
91. 若要返回设计视图，请在 **“运行”** 功能区选项卡中单击 **“视图”** 功能组中的 **“设计”**。

...
29. 要创建层次结构，请在 **“字段”** 窗格中右键单击 **“Category”** 列，然后选择 **“创建层次结构”**。

	![图片 341](Linked_image_Files/PowerBI_Lab04A_image16.png)

30. 在 **“属性”** 窗格（ **“字段”** 窗格左侧）中，将 **“名称”** 框中的文本替换为 **“Products”**。

	![图片 344](Linked_image_Files/PowerBI_Lab04A_image17.png)

31. 若要向层次结构添加第二个级别，请在 **“层次结构”** 下拉列表中选择 **“子类别”**。

32. 要向层次结构添加第三个级别，请在 **“层次结构”** 下拉列表中选择 **“Product”**。

33. 要完成层次结构设计，请单击 **“应用级别更改”**。

	![图片 343](Linked_image_Files/PowerBI_Lab04A_image18.png)

	*提示：务必单击 **“应用级别更改”**，忽略此步骤是一种常见错误*。

34. 在**字段**窗格中，请注意 **“Products”** 层次结构。

	![图片 347](Linked_image_Files/PowerBI_Lab04A_image19.png)

35. 若要显示层次结构级别，请展开 **Products** 层次结构。

	![图片 346](Linked_image_Files/PowerBI_Lab04A_image20.png)

36. 若要将列组织到一个显示文件夹中，请先选择**字段**窗格中的 **“背景颜色格式”** 列。

37. 按住 **Ctrl** 键，然后选择 **“字体颜色格式”**。

38. 在**属性**窗格中的 **“显示文件夹”**框内，输入 **“格式”**。

	![图片 348](Linked_image_Files/PowerBI_Lab04A_image21.png)

39. 在 **“字段”** 窗格中，注意这两列现在位于一个文件夹中。
...
41. 选择 **“Country”** 列（不是 **“Country”** 级别）。

42. 在 **“属性”** 窗格中，展开 **“高级”** 部分，然后选择 **“数据类别”** 下拉列表中的 **“国家/区域”**。
...
44. 创建第二个层次结构，命名为 **“Geography”**，分为以下四个级别：
...
49. 在 **“属性”** 窗格中的 **“格式”** 部分内，将 **“千位分隔符”** 属性滑动至 **“开”**。

	![图片 357](Linked_image_Files/PowerBI_Lab04A_image28.png)

50. 选择 **“单价”** 列。

51. 在 **“属性”** 窗格的 **“格式设置”** 部分，将 **“小数位数”** 属性滑动至 **“2”**。

52. 在 **“高级”** 组（可能需要向下滚动才能找到）的 **“汇总方式”** 下拉列表中选择 **“平均值”**。
...
56. 在 **“属性”** 窗格中，从 **“格式设置”** 部分内将 **“小数位数”** 属性设置为 **“0”** （零）。
...
59. 展开 **“Sales”** | **OrderDate”** 字段，然后注意其展示了一个日期层次结构。
...
60. 单击 **“文件”** 功能区选项卡打开 backstage 视图即可关闭自动/日期时间。

61. 选择左侧的 **“选项和设置”**，然后选择 **“选项”**。

	![图片 360](Linked_image_Files/PowerBI_Lab04A_image33.png)

62. 在**选项**窗口左侧的 **“当前文件”** 组中选择 **“数据加载”**。

	![图片 361](Linked_image_Files/PowerBI_Lab04A_image34.png)

63. 在 **“时间智能”** 部分，取消选中 **“自动日期/时间”**。
...
67. 在 **“快速度量值”** 窗口的 **“计算”** 下拉列表中，从 **“数学运算”** 组内选择 **“减法”**。

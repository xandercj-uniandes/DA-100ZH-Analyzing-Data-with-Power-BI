...
8. 在 **“选择创建报表所需的数据集”** 窗口中，选择 **“销售分析”** 数据集。
...
10. 在右下角的状态栏中，请注意已建立实时连接。

11. 在 **“字段”** 窗格中，请注意已列出数据模型表。
...
14. 将页面重命名为 **“概述”**，然后按 **Enter**。

	![图片 37](Linked_image_Files/PowerBI_Lab08A_image11.png)

15. 要添加图片，请在 **“插入”** 功能区选项卡，从 **“元素”** 组里面，单击 **“图片”**。

	![图片 10](Linked_image_Files/PowerBI_Lab08A_image12.png)

16. 在 **“打开”** 窗口中，导航到 **“D:\DA100\Data”** 文件夹。

17. 选择 **“AdventureWorksLogo.jpg”** 文件，然后单击 **“打开”**。

	![图片 11](Linked_image_Files/PowerBI_Lab08A_image13.png)

18. 拖动图像以将其重新放置在左上角，并拖动引导标记以调整其大小。

	![图片 12](Linked_image_Files/PowerBI_Lab08A_image14.png)

19. 要添加切片器，请先通过单击报表页面的空白区域来取消选择图像。

20. 在 **“字段”** 窗格中，选择 **“日期”** | **“年”** 字段（不是 **“年”** 层次级别）。

21. 请注意，年份值表已添加到报表页面。

22. 要将视觉对象从表格转换为切片器，请在 **“可视化”** 窗格中，选择 **“切片器”**。

	![图片 15](Linked_image_Files/PowerBI_Lab08A_image15.png)

23. 要将切片器从列表转换为下拉列表，请在切片器的右上角，单击向下箭头，然后选择 **“下拉”**。

	![图片 18](Linked_image_Files/PowerBI_Lab08A_image16.png)

24. 调整切片器的大小并重新放置，使其位于图像下方，从而使宽度与图像相同。

	![图片 19](Linked_image_Files/PowerBI_Lab08A_image17.png)

25. 在 **“年”** 切片器，选择 **“2020财年”**，然后折叠下拉列表。

	![图片 20](Linked_image_Files/PowerBI_Lab08A_image18.png)

	报表页面现在按 **“FY2020”** 筛选。

26. 通过单击报表页面的空白区域来取消选择切片器。

27. 基于 **“区域”** 创建第二个切片器 | **“区域”** 字段（不是**区域**层级）。

28. 将切片器保留为列表，然后调整切片器的大小并将其重新放置在 **“年份”** 切片器下。

	![图片 21](Linked_image_Files/PowerBI_Lab08A_image19.png)

29. 要格式化切片器，请在 **“可视化”** 窗格中，打开 **“格式”** 窗格。
...
31. 将 **“显示‘全选’选项”** 设置为 **“启用”**。

	![图片 24](Linked_image_Files/PowerBI_Lab08A_image22.png)

32. 在 **“区域”** 切片器中，请注意第一个项目现在是 **“全选”**。

	*选中后，此项目将全选或取消选择所有项目。它使报表用户更容易设置正确的筛选器*。

33. 通过单击报表页面的空白区域来取消选择切片器。

34. 要向页面添加图表，请在 **“可视化”** 窗格中，单击 **“折线图和堆积柱形图”** 视觉对象类型。

	![图片 25](Linked_image_Files/PowerBI_Lab08A_image23.png)

35. 调整视觉对象的大小和位置，使其位于徽标的右侧，从而填充报表页面的宽度。
...
46. 通过单击报表页面的空白区域来取消选择图表。

47. 要向页面添加图表，请在 **“可视化”** 窗格中，单击 **“堆积条形图”** 视觉对象类型。

	![图片 34](Linked_image_Files/PowerBI_Lab08A_image30.png)

48. 调整该视觉对象的大小和位置，使之填充报表页面的剩余空间。
...
56. 根据 **“Region | Region”** 字段添加切片器。

57. 使用 **“格式”** 窗格启用“全选”选项（在 **“选择控件”** 组中）。

58. 调整该切片器的大小和位置，使之位于报表页面的左侧，大约占页面高度的一半。

	![图片 44](Linked_image_Files/PowerBI_Lab08A_image37.png)

59. 添加矩阵视觉对象，并调整大小和位置，使之填充报表页面的剩余空间

	![图片 45](Linked_image_Files/PowerBI_Lab08A_image38.png)

60. 将 **“Date | Fiscal”** 层次结构添加到“矩阵”视觉对象的 **“行”** 井。

	![图片 46](Linked_image_Files/PowerBI_Lab08A_image39.png)

61. 添加以下五笔 **“销售”** 表字段至 **“值”** 井：
...
66. 要折叠 **“筛选器”** 窗格，请在窗格的右上方，单击箭头。

	![图片 68](Linked_image_Files/PowerBI_Lab08A_image44.png)

67. 保存 Power BI Desktop 文件。
...
69. 要在报表设计和测试过程中模拟行级安全筛选器，请将 **“Salesperson (Performance) | Salesperson”** 字段添加到 **“筛选器”** 窗格上的 **“此页上的筛选器”** 井内。

70. 在筛选器卡中，向下滚动销售员列表，然后查看 **“Michael Blythe”**。

	![图片 73](Linked_image_Files/PowerBI_Lab08A_image46.png)

	*在实**验室 12A**的应用中分发报表之前，系统将指示你删除此筛选器*。

71. 根据 **“Date | Year”** 字段添加下拉切片器，然后调整大小和位置，使之位于页面的左上角。
...
73. 添加一个 **“多行卡”** 视觉对象，然后调整其大小和位置，使其位于切片器的右侧并填充页面的剩余宽度。
...
76. 添加一个 **“簇状条形图”** 视觉对象，然后调整其大小和位置，使其位于多行卡视觉对象的下方，并填充页面的剩余高度，达到多行卡视觉对象宽度的一半。
...
78. 要创建视觉对象的副本，请按 **“Ctrl+C”**，然后按 **“Ctrl+V”**。

79. 将复制的视觉对象放在原始视觉对象的右侧。

	![图片 82](Linked_image_Files/PowerBI_Lab08A_image55.png)

80. 要修改可视化效果类型，请在 **“可视化效果”** 窗格中，选择 **“簇状柱形图”**。
...
82. 保存 Power BI Desktop 文件。

83. 在 **“主页”** 功能区选项卡上的 **“共享”** 组中，单击 **“发布”**。

	![图片 64](Linked_image_Files/PowerBI_Lab08A_image57.png)

84. 将报表发布到 **“销售分析”** 工作区。

85. 保持 Power BI Desktop 打开状态。

...
8. 在 **“共享仪表板”** 窗格 (位于右侧) 中的 **“允许访问”** 框中，开始键入课堂伙伴的帐户名称，并在列出后选择它。
...
13. 若要打开仪表板，请单击 **“销售监视”** 仪表板。

14. 可以看到仪表板 **“本年累计销售额”** 磁贴值是 **“1300 万美元”**。
...
18. 请注意，发布应用的进程需要在这三个选项卡中进行配置：**“安装”**, **“导航”** 和 **“权限”**。
...
21. 在 **“打开”** 窗口，导航到 **“D:\DA100\Lab12A\Assets\Icons”** 文件夹。

22. 选择一个 JPG 文件，然后单击 **“打开”**。
...
27. 在 **“特定个人或组”** 框内，开始输入课堂伙伴的帐户名，并在列出后选择它。
...
33. 在 AppSource 窗口中，对于你的课堂合作伙伴发布的 **“销售分析”** 应用，单击 **“立即获取”** 链接。

	![图片 140](Linked_image_Files/PowerBI_Lab12A_image21.png)

34. 添加应用后，单击应用磁贴即可打开应用。

	![图片 141](Linked_image_Files/PowerBI_Lab12A_image22.png)

35. 打开应用后，查看导航窗格（位于左侧）。

36. 请注意，导航窗格中的第一项已打开。

37. 在导航窗格中，展开 **“销售报表”**，然后选择**概述**页。

 	![图片 143](Linked_image_Files/PowerBI_Lab12A_image23.png)

38. 注意 **“Region”** 切片器仅显示两个区域，这两个区域都是分配给 Pamela Ansam-Wolfe 的区域。

	![图片 145](Linked_image_Files/PowerBI_Lab12A_image24.png)

39. 选择 **“我的业绩”** 页面。

40. 请注意，该页面显示了 Pamela Ansam-Wolfe 的销售和目标。

41. 打开 **Sales Exploration** 报表，然后与每个页面上的视觉对象进行交互。
